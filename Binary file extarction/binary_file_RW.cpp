...
//
//
//In this C++ program we will learn how to read an employee's details
// from keyboard using class and object then write that object into
// the file? We will also read the object and display employee's record
// on the screen.
